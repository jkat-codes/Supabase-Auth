...
export function OtpForm({setCurrentView}) {
    ...
    const isButtonDisabled = emailValue.length === 0 || emailError !== ''; 
    ...
    return (
       <div className="form-container">
            ...
            <input data-testid="email-input" type="email" name="" id="" placeholder="Email" className="input-field" value={emailValue} onChange={handleEmailChange}/>
            <div id="otp-container" className="otp-container hidden">

            </div>
            <button data-testid="submit-button" className="confirm-btn" id="signin-btn" onClick={handleSubmitEmail} disabled={isButtonDisabled}>Send Code</button>
